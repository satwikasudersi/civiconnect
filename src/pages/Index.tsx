      ...
      {activeTab === 'reports' && (
        <section className="relative overflow-hidden bg-gradient-hero">
          <div className="absolute inset-0 opacity-20">
            <img 
              src={civicHero} 
              alt="Civic community illustration" 
            ...
            <div className="text-center">
              ...
              <div className="flex flex-col sm:flex-row gap-4 justify-center">
                ...
                <button 
                  ...
                  className="bg-primary-foreground/10 text-primary-foreground px-8 py-4 rounded-lg font-semibold text-lg border border-primary-foreground/20 hover:bg-primary-foreground/20 transition-smooth"
                >
                  View Status Updates
                </button>
              </div>
